...
v4.2.0 - Added CreateMyPaths Subroutine to address bug whereas the Comptime Folder nor Comptimerun/Bank files would not be created on first run if the user did not enter a balance at first start.

v4.2.1 - Cleaned up variables and eleminated the bank file.   Form now pulls bank from comptimerun.txt file as I always intended.

v4.2.5 - Added the ability to Differentiate between Comp/Straight Time.  Eleminated Chief's Ed. 
